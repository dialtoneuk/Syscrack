...
<html lang="en">
    ...
    <?php
        ...
        Render::view('developer/templates/template.header', array( 'pagetitle' => 'Developer / Errors'));
    ?>
    <body>
        <div class="container">
            ...
            <div class="row">
                ...
                <?php
                    if( $settings['error_logging'] == false )
                    {
                        ?>
                                ...
                                <?php
                                    ...
                                    else
                                    {
                                        ...
                                        for( $key = count( $error_log ), $count=1; $key > 0; $key--, $count++)
                                        {
                                            ...
                                            <div style='cursor: hand' class="panel panel-info" onclick="window.location.href='/<?=$settings['developer_page'] . '/errors/' . ( $key - 1 )?>'">
                                                <div class="panel-heading">
