            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><span class="glyphicon glyphicon glyphicon-usd"></span> Purchase from various marketplaces softwares and hardwares.</li>
                ...
                <div class="col-md-6">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body text-center">
                            ...
                            <p>
                                Join our discord and give us suggestions! We have a very active community of hackers, programmers and
                                modders who are always looking to help new players, go give it a spin! We will also announce new updates
                                here just before they are released.
                            </p>
                            <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                <div class="btn-group" role="group">
                                    <button type="button" onclick="window.location.href = '<?=Settings::getSetting('syscrack_discord_main')?>'" class="btn btn-info">Join Discord</button>
                                </div>
                            </div>
                        </div>
                    </div>
