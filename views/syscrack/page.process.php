                                        ...
                                        <h5 style="color: #ababab" class="text-uppercase">
                                            <?php
                                                ...
                                                if( $computers->getCurrentUserComputer() == $computer->computerid )
                                                {
                                                    ...
                                                    ?>
                                                    <p><a href="/processes/computer/<?=$computerid?>" class="btn btn-primary" role="button">Task Manager</a> <span>This is your current computer</span></p>
                                                    <?php
                                                }
                                                else
                                                {
                                                    ...
                                                    ?>
                                                        <?=$computer->ipaddress?> <span class="badge" style="float: right;">Switch to VPC</span>
                                                    <?php
                                                }
                                            ?>
                                        ...
                                        <?php
                                            foreach( $value as $item=>$process )
                                            {
                                                ...
                                                if( $computers->getCurrentUserComputer() == $computer->computerid )
                                                {
                                                    ...
                                                    ?>
                                                        <div class="row">
                                                            <?php Flight::render('syscrack/templates/template.process',array('processid' => $process->processid, 'processcclass' => $operations->findProcessClass( $process->process ) ) ); ?>
                                                        </div>
                                                    <?php
                                                }
                                                else
