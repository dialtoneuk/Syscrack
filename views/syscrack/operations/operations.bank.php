                            ...
                            <?php
                                ...
                                if( $finance->hasAccountAtComputer( $current_computer->computerid, $userid ) )
                                {
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <p class="text-center">
                                                <strong>Warning</strong> Deleting your account will mean that you lose all the cash currently in that account... so be
                                                careful!
                                            </p>
                                            <form method="post" style="width: 100%;">
                                                <div class="btn-group" role="group" aria-label="Create bank account" style="width: 100%;">
                                                    <button type="submit" name="action" value="delete" class="btn btn-danger" style="width: 50%;">Delete Account</button>
                                                    <button type="button" class="btn btn-success" onclick="window.location.href = '/finances/transfer/'" style="width: 50%;">Transfer</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                else
                                {
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <p class="text-center">
                                                You currently don't have an account at this bank, but its free to create one! There is also a signup bonus
                                                of <strong><?=Settings::getSetting('syscrack_currency') . number_format( Settings::getSetting('syscrack_bank_default_balance') )?></strong>
                                            </p>

                                            <form method="post" style="width: 100%;">
                                                <div class="btn-group" role="group" aria-label="Create bank account" style="width: 100%;">
                                                    <button type="submit" name="action" value="create" class="btn btn-default" style="width: 100%;">Create</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
