                                                        ...
                                                        <div class="col-sm-8">
                                                            <ul class="list-group">
                                                                <li class="list-group-item">
                                                                    Account Address <span class="badge right"><a style="color: white;" href="/game/internet/<?=$value['ipaddress']?>/"><?=$value['ipaddress']?></a></span>
                                                                </li>
                                                                <li class="list-group-item">
                                                                    Account Created <span class="badge right"><?=date("F j, Y, g:i a", $account->timecreated )?></span>
                                                                </li>
                                                            </ul>
