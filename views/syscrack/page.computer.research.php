                    ...
                    <div class="tab-content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            <span class="glyphicon <?=$softwares->getIcon( $software->softwareid )?>"></span> <?=$software->softwarename?> <span class="badge" style="float: right;"><?=$software->level?></span>
                                                        </div>
                                                        <div class="panel-body">
                                                            <?php
                                                            ...
                                                            <ul class="list-group">
                                                                <li class="list-group-item">
                                                                    Owner <span class="badge right"><?=$user->getUsername( $data['license'] )?></span>
                                                                </li>
                                                                <li class="list-group-item">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p>
                                        ...
                                        on how high the softwares level appears to be, as well as a few other variables. Including
                                        ...
                                        if( empty( $accounts ) )
                                        {
                                            ...
                                            ?>
                                                <div class="panel panel-warning">
                                                    ...
                                                    <div class="panel-body">
                                                        You currently don't have any bank accounts, you should probably go create one if you want
                                                        to license software.
                                                    </div>
                                                </div>
                                            <?php
                                                ...
                                                <div class="panel panel-info">
                                                    <div class="panel-body">
                                                        <form method="post">
                                                            ...
                                                            <button style="width: 100%; margin-top: 2.5%;" class="btn btn-primary" name="action" value="licensesoftware" type="submit">
                                                                <span class="glyphicon glyphicon-cog" aria-hidden="true"></span> License Software
                                                            </button>
                                                        </form>
                                                    </div>
                                                </div>
                        ...
                        <div id="researchsoftware" class="tab-pane fade" style="padding-top: 2.5%;">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p>
                                        Here you can research a software to a desired level of your choice. Simply choose which licensed software you would
                                        like to research and the level of which you'd like to research it too. Researching is completely free, the only thing
