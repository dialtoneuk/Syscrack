...
<div class="row">
    <div class="col-lg-12">
        <h5 style="color: #ababab" class="text-uppercase rainbow">
            <marquee>Ambiguity</marquee>
        </h5>
        <div class="embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/SunHEbNViZk?autoplay=1" frameborder="0" allowfullscreen></iframe>
        </div>
    </div>
</div>