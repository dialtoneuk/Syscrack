            ...
            <div class="nav navbar-left navbar-fix">
                ...
                if ($session->isLoggedIn()) {
                    if ($computers->hasCurrentComputer()) {
                        ...
                        <a class="navbar-brand" style="font-size: 12px" href="/computer/" ata-toggle="tooltip"
                           data-placement="auto" title="Current IP Address">
                            <span class="glyphicon glyphicon-cloud" data-toggle="tooltip" data-placement="auto"
                ...
                if ($session->isLoggedIn()) {
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle text-uppercase" data-toggle="dropdown" role="button"
                           ...
                           aria-expanded="false"><span class="glyphicon glyphicon-tasks"></span></a>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle text-uppercase" data-toggle="dropdown" role="button"
                           ...
                           aria-expanded="false"><span class="glyphicon glyphicon-gbp"></span></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle text-uppercase" data-toggle="dropdown" role="button"
                           ...
                           aria-expanded="false"><span class="glyphicon glyphicon-folder-open"></span></a>
                        <ul class="dropdown-menu">
                    ...
                    if ($user->isAdmin($session->getSessionUser())) {
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle text-uppercase" data-toggle="dropdown" role="button"
                               ...
                               title="Admin Control Panel" aria-expanded="false"><span
