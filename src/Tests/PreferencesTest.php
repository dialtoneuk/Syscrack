	...
	class PreferencesTest extends BaseTestCase
	{
		...
		public static function setUpBeforeClass(): void
		{
			...
			if( self::$preferences->has( self::$userid ) == false )
				self::$preferences->set( self::$userid, ["cracker" => 11] );
		...
		public function testGetSoftwarePreference()
		{
			...
			$result = self::$preferences->getSoftwarePreference( self::$userid, "cracker");
		...
		public function testGet()
		{
			...
			$this->assertNotEmpty( $result );
			$this->assertArrayHasKey("cracker", $result );
		}

		public function testHasSoftwarePreference()
		{

			$this->assertTrue( self::$preferences->hasSoftwarePreference( self::$userid, "cracker") );
		}

		public function testAdd()
		{

			self::$preferences->add( self::$userid, array('hasher' => 24) );

			$result = self::$preferences->get( self::$userid );

			$this->assertNotEmpty( $result );
			$this->assertArrayHasKey("hasher", $result );
		}
